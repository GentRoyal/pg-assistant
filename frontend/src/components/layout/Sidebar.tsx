...
export function Sidebar({ open, onClose }: Props) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-[min(288px,86vw)] flex-col bg-[var(--ui-navy)] text-white transition-transform duration-300 ease-out lg:static lg:z-auto lg:w-[272px] lg:translate-x-0 ${
